...
gp_corpus=/mnt/disk01/globalphone/Mandarin
gp_lexicon=/mnt/corpora/Globalphone/GlobalPhoneLexicons/Mandarin/Mandarin-GPDict.txt
gp_lm=http://www.csl.uni-bremen.de/GlobalPhone/lm/MAN.3gram.lm.gz

tmpdir=data/local/tmp/gp/mandarin
